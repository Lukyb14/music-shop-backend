...
class SearchSoundCarrierServiceTest {
    ...
    @Test
    void given_2soundCarriersinrepository_when_totResultsByAlbumName_then_expecttotResultsByAlbumNameequals() throws RemoteException {
        //given
        List<SoundCarrier> soundCarriers = Arrays.asList(
                createSoundCarrierDummy(),
                createSoundCarrierDummy()
        ...
        int totResults = searchSoundCarrierService.totResultsByAlbumName("Black and White");
    ...
    @Test
    void given_2soundCarriersinrepository_when_soundCarriersByArtistName_then_expectsoundsCarriersequals() throws RemoteException {
        //given
        List<SoundCarrier> soundCarriers = Arrays.asList(
                createSoundCarrierDummy(),
                createSoundCarrierDummy()
    ...
    @Test
    void given_2soundCarriersinrepository_when_totResultsByArtistName_then_expecttotResultsByArtistNameequals() throws RemoteException {
        //given
        List<SoundCarrier> soundCarriers = Arrays.asList(
                createSoundCarrierDummy(),
                createSoundCarrierDummy()
        ...
        int totResults = searchSoundCarrierService.totResultsByArtistName("Bob");
    ...
    @Test
    void given_2soundCarriersinrepository_when_soundCarriersBySongName_then_expectsoundsCarriersequals() throws RemoteException {
        //given
        List<SoundCarrier> soundCarriers = Arrays.asList(
                createSoundCarrierDummy(),
                createSoundCarrierDummy()
    ...
    @Test
    void given_2soundCarriersinrepository_when_totResultsBySongName_then_expecttotResultsBySongNameequals() throws RemoteException {
        //given
        List<SoundCarrier> soundCarriers = Arrays.asList(
                createSoundCarrierDummy(),
                createSoundCarrierDummy()
        ...
        //when
        int counter = 2;
        int totResults = searchSoundCarrierService.totResultsBySongName("Hello World");
    ...
    @Test
    void given_1soundCarriersinrepository_when_soundCarrierDetailsByArticleId_then_SoundcarriersDetailDTOequals() throws RemoteException {
        //given
