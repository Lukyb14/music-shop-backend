...
@Stateless
public class AuthenticationServiceEJB implements AuthenticationServiceRemote {
    ...
    public AuthenticationServiceEJB() {
        this(new HibernateUserRepository(), new ListSessionRepository());
        loggedInClientsMap = new HashMap();
    }

    public AuthenticationServiceEJB(UserRepository userRepository, SessionRepository sessionRepository) {
