...
public class SearchCustomerServiceEJB implements SearchCustomerServiceRemote {
    ...
    public SearchCustomerServiceEJB(){
        Object obj = null;
        try {
            InitialContext ctx = EJBClient.getContext();

            obj = ctx.lookup("ejb:/music-shop-backend-customer-1.0-SNAPSHOT/SearchCustomerServiceEJB!at.fhv.teame.sharedlib.ejb.CustomerServiceRemote");
